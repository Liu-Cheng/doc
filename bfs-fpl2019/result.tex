...
It improves the performance by 9.8\% to 16.7\%. 
 ...
 \begin{figure}
	\center{\includegraphics[width=0.8\linewidth]{opt-analysis}}
...
\begin{figure}
	\center{\includegraphics[width=0.75\linewidth]{batch-perf}}
...
\begin{figure}
	\center{\includegraphics[width=0.75\linewidth]{batch-overhead}}
