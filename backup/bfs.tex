...
\begin{abstract}
    ...
    parallel computing architectures due to the irregular memory access and low 
    computation-to-memory ratio. With the high level design tools, we can rapidly identify the 
    performance bottleneck and implement corresponding optimization strategies 
    such as pipeling, prefetching and caching for the BFS. 
    According to the experiments on a set of big graphs, the optimized HLS based BFS accelerator 
