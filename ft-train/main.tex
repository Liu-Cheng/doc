...
\begin{figure*}
	...
	\subfloat[]{
		\label{fig:lenet}
		\includegraphics[width=0.45\linewidth]{lenet-overclock}
	}
	\qquad
	\subfloat[]{
                \label{fig:alexnet}
                \includegraphics[width=0.45\linewidth]{alexnet-overclock}
        }
	\qquad
	\subfloat[]{
                \label{fig:vgg16}
                \includegraphics[width=0.45\linewidth]{vgg16-overclock}
        }
        \qquad
	\subfloat[]{
                \label{fig:vgg19}
                \includegraphics[width=0.45\linewidth]{vgg19-overclock}
        }
...
\begin{figure*}
        ...
        \subfloat[]{
                \label{fig:lenet}
                \includegraphics[width=0.45\linewidth]{lenet-softerror}
        }
        \qquad
        \subfloat[]{
                \label{fig:alexnet}
                \includegraphics[width=0.45\linewidth]{alexnet-softerror}
        }
        \qquad
        \subfloat[]{
                \label{fig:vgg16}
                \includegraphics[width=0.45\linewidth]{vgg16-softerror}
        }
        \qquad
        \subfloat[]{
                \label{fig:vgg19}
                \includegraphics[width=0.45\linewidth]{vgg19-softerror}
        }
