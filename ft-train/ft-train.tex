...
% affiliations
\author{\IEEEauthorblockN{Dawen Xu\textsuperscript{1}, Kouzi Xing\textsuperscript{1}, Cheng Liu\textsuperscript{2}, Ying Wang\textsuperscript{2}, Yulin Dai\textsuperscript{1}, Long Cheng\textsuperscript{3}, Huawei Li\textsuperscript{2}, Lei Zhang\textsuperscript{2}}
...
are increasingly adopted in massive AI applications and have become 
one of the key computing infrastructures. To gain higher energy 
efficiency or performance, many hardware design optimizations 
such as near-threshold logic or overclocking can be utilized. 
In these cases, timing violations may happen and cause computing 
errors. The computing errors are difficult to be captured 
