...
In \cite{distillation_39}, the logits of the teacher network are divided by a temperature factor t. 
Using a higher value for t produces a softer probability distribution when taking the Softmax of the logits
