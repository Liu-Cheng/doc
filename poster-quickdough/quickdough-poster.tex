...
QuickDough an SCGRA based FPGA accelerator design methodology as shown in Figure \ref{fig:quickdough} is proposed to compile an application to a hybrid CPU+FPGA system. It has the compute intensive kernels scheduled to the SCGRA overlay and the rest compiled to CPU.
...
\headerbox{Experiment-1}{name=experiment-1,column=1,below=quickdough}{
Design productivity, performance, implementation frequency and scalability of both Vivado HLS basd design methodology and QuickDough are presented. Design productivity comparison is shown in Figure \ref{fig:hls-compilation-time} and \ref{fig:quickdough-compilation-time}. End-to-end performance is compared in Figure \ref{fig:real-perf}. Kernel simulation performance and SCGRA implementation frequency are compared in Figure \ref{fig:kernel-sim-perf} and \ref{fig:impl-freq} respectively. Implementation scalability of the SCGRA overlay is presented in Figure \ref{fig:scgra-impl-scalability}.
...
\headerbox{Experiment-2}{name=experiment-2,column=2,row=0}{
...
\begin{center}
  ...
  \captionof{figure}{Normalized Overall Performance}
  \label{fig:real-perf}
\end{center}

\begin{center}
  \includegraphics[width=0.99\linewidth]{kernel-sim-perf}
  \captionof{figure}{Normalized Kernel Simulation Performance}
...
\begin{center}
  \includegraphics[width=0.99\linewidth]{scgra-impl-scalability}
  \captionof{figure}{SCGRA Implementation Scalability}
  \label{fig:scgra-impl-scalability}
\end{center}
